...
def main():
    ...
    # Fetch a static validation sample from the preprocessed dataset for real-time health checks
    val_sample_processed = processed_dataset[0]
    print(f"✅ Loaded validation sample index 0.")
