...
def parse_args():
    ...
    parser.add_argument("--processor_dir", default="research/processor_dir", help="Path to local Wav2Vec2 processor directory")
    parser.add_argument("--dict_path", default="research/g2p/output_full.dict", help="Path to G2P mapping dictionary")
