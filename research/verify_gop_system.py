...
# Ensure research/ directory is in path
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

from inference_api import init_pipeline, run_inference
...
def main():
    ...
    temp_dir = "research/g2p"  # save within the research directory structure
